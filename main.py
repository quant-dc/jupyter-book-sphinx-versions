...
DOC_PATH = Path("notebooks")
SWITCHER_PATH = DOC_PATH / "_static" / "switcher.json"
                ...
                switcher += [
                    {
                        ...
                        "url": "https://quant-dc.github.io/jupyter-book-sphinx-versions/index.html",
                    },
                    {
                        "name": str(version),
                        "version": str(version),
                        "url": f"https://quant-dc.github.io/jupyter-book-sphinx-versions/archive/{version}/index.html",
                    },
                ]
                ...
                switcher += [
                    {
                        ...
                        "version": str(src_version),
                        "url": f"https://quant-dc.github.io/jupyter-book-sphinx-versions/archive/{src_version}/index.html",
                    }
                ]
            else:
